...
export default function MainFooter({ locale = 'en' }: { locale?: string }) {
    ...
    return (
        <footer className="border-t border-yellow-500/20 bg-black/90 text-gray-300 relative z-10">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 py-10 sm:py-12">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 sm:gap-10">
                    ...
                    <div className="text-center sm:text-left">
                        ...
                        <p className="text-gray-400 text-xs sm:text-sm mb-3 sm:mb-4">{ui.follow}</p>
                    ...
                    <div className="text-center sm:text-left lg:text-right">
                        ...
                        <ul className="space-y-2 text-xs sm:text-sm text-gray-400">
                            <li>
                                <Link href={`/${locale}/about`} className="hover:text-yellow-300 transition-colors inline-block">
                                    {ui.about}
                                </Link>
                            </li>
                            <li>
                                <Link href={`/${locale}/research`} className="hover:text-yellow-300 transition-colors inline-block">
                                    {ui.research}
                                </Link>
                            </li>
                            <li>
                            ...
                            <li className="pt-2">
                                <a href="mailto:contact@yugnex.com" className="hover:text-yellow-300 transition-colors inline-block">
                                    contact@yugnex.com
                                </a>
                            </li>
                        </ul>
            ...
            <div className="border-t border-yellow-500/10 py-3 sm:py-4">
                <p className="text-center text-xs text-gray-500 uppercase tracking-wide px-4">
                    © {new Date().getFullYear()} YugNex Technology OPC Pvt. Ltd. All rights reserved.
                </p>
            </div>
        </footer>
    )
